-- Complete APPI Database Setup Script (Final Version)
-- This script sets up all necessary database changes for member settings and verification system
-- Handles existing objects gracefully to avoid errors
...
-- Add indexes for new fields (ignore if they exist)
DO $$ BEGIN
...
-- Add indexes for better performance (ignore if they exist)
DO $$ BEGIN
...
-- Storage indexes (ignore if they exist)
DO $$ BEGIN
